...
class ABogus:
    ...
    ```python
        ...
        abogus_param = abogus.generate_abogus("device_platform=webapp&aid=6383&channel=channel_pc_web&aweme_id=fixture-item……省略……")
...
if __name__ == "__main__":
    ...
    params = "device_platform=webapp&aid=6383&channel=channel_pc_web&sec_user_id=fixture-user&max_cursor=0&locate_query=false&show_live_replay_strategy=1&need_time_list=1&time_list_query=0&whale_cut_token=&cut_version=1&count=18&publish_video_strategy_type=2&from_user_page=1&update_version_code=170400&pc_client_type=1&pc_libra_divert=Windows&support_h265=1&support_dash=0&version_code=290100&version_name=29.1.0&cookie_enabled=true&screen_width=1920&screen_height=1080&browser_language=zh-CN&browser_platform=Win32&browser_name=Edge&browser_version=131.0.0.0&browser_online=true&engine_name=Blink&engine_version=131.0.0.0&os_name=Windows&os_version=10&cpu_core_num=12&device_memory=8&platform=PC&downlink=10&effective_type=4g&round_trip_time=50"
    body = ""
    ...
    body = "aweme_type=0&item_id=fixture-item&play_delta=1&source=0"
    print(url + abogus.generate_abogus(params=params, body=body)[0])
